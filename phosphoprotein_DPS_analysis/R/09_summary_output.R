## =========================================================
## 09_summary_output.R
## Summary Table Generation for DPS Analysis
## =========================================================

## ===== Read DPS meta-analysis table =====
...
.add_sig_counts_meta_dps <- function(df, alphas = c(0.05, 0.25)) {
    ...
    for (a in alphas) {
        ...
        ## How many subunits reached padj_meta < a for this site
...
## ===== Summarize meta-FDR across subunits =====
summarize_meta_fdr_across_subunits <- function(
  meta_root = "phospho_DPS_meta",
  ...
  stat_tag = "DPS_meta_stouffer"
    ...
    for (st in strata) {
        for (ver in versions) {
            ...
            ## Auto-detect subunit/predictor names
...
## ===== One-click summary execution =====
posthoc_summary_meta_fdr <- function(meta_root = "phospho_DPS_meta") {
